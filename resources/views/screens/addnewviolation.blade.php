...
<head>
    ...
    <title>Add New Violation Types</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Add New Violation Type Card -->

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add Violation Type</h6>
                        </div>
                        <div class="card-body">
                        <form action="{{ route('vtypesstore') }}" method="POST" enctype="multipart/form-data">
                            @csrf
